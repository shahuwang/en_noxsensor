---
linkTitle: "PSA Group"
title: Fortisor® PSA Group NOx Sensor OE List
description: Fortisor offers the complete OE cross-reference list for all PSA Group NOx sensors. Find the perfect high-quality replacement sensor for your car, SUV, or commercial vehicle by part number.
breadcrumbs: true
date: "2025-10-19T00:35:28+08:00"
draft: false
swiper_images:
  - "./assets/peugeot_1.avif"
  - "./assets/peugeot_2.avif"
  - "./assets/peugeot_3.avif"
  - "./assets/peugeot_4.avif"
  - "./assets/peugeot_5.avif"
  - "./assets/peugeot_6.avif"
  - "./assets/peugeot_7.avif"
  - "./assets/peugeot_8.avif"
  - "./assets/peugeot_9.avif"
  - "./assets/peugeot_10.avif"
---

*Fortisor® offers the complete OE cross-reference list for all PSA Group NOx sensors.  
...
**Fortisor®** understands the stringent demands placed on NOx sensors within the PSA Group SCR system—**precision, reliability, and longevity are non-negotiable**.This page provides the complete OE Cross Reference List for Mercedes car, SUV, and commercial applications. We are not just a supplier; we are a technical brand deeply focused on emission control technology.
...
#### Fortisor® NOx Sensors: Engineered for PSA Group Reliability
...
3.  **Communication Protocol & Coverage (The Fortisor® Advantage):**
    > **[Superior Multi-Protocol Compatibility]**: Our ECU chips feature **Multi-Protocol Compatibility Technology**, enabling the sensor to communicate seamlessly with the ECUs of a *wider range of PSA Group models*. This broad compatibility means that, **provided the physical probe shape is correct, a single Fortisor® part can service multiple OE numbers and vehicle variants**, dramatically simplifying inventory and spare parts management for workshops.
...
We guarantee that a Fortisor sensor will meet or exceed the performance and lifespan requirements of the original PSA Group unit.



#### PSA Group NOx Sensor OE Part Number Cross Reference
Below is a reference list of PSA Group NOx Sensor OE Part Numbers. Please note that this list is not exhaustive.  
...
| 1         | 2         | 3         | 4         | 5         |6          |7          |8          |
| ---       | ---       | ---       | ---       | ---       | ---       | ---       | ---       |
|9816276480 |9678570780 |9821120980 |9675358480 |9821121180 |9817308880 |9821120780 |9817454580 |
|22790 5444R|22790 8539R|22790 8265R|22790 5433R|22790 3682R|22790 2682R|           |           |
